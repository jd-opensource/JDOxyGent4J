...
/**
 * Demo example class from README documentation, demonstrating how to configure and use basic functionality of OxyGent framework
...
public class DemoInReadme {
    ...
    public static List<BaseOxy> getDefaultOxySpace() {
        ...
        return Arrays.asList(
                ...
                ReActAgent.builder()
                        .name("file_agent")
                        .desc("Tool agent capable of operating file system")
                ...
                ReActAgent.builder()
                        .name("math_agent")
                        .desc("Tool agent capable of performing mathematical calculations")
    ...
    public static void main(String[] args) throws Exception {
        ...
        BrowserOpener.open(String.format("http://%s:%s/web/index.html", ServerConstants.DEFAULT_HOST_NAME,"8080"));
