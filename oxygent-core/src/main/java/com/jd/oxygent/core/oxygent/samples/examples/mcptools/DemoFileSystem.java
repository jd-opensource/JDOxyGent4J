...
public class DemoFileSystem {
    ...
    public static List<BaseOxy> getDefaultOxySpace() {
        return Arrays.asList(
                ...
                OSUtil.isWindows() ?
                        // windows version
                        new StdioMCPClient("filesystem_tool",
                                "cmd",
                                Arrays.asList("/c", "npx", "-y", "@modelcontextprotocol/server-filesystem",
                                        "D:"
                                )) {{
                            setCategory("tool");
                            setClassName("StdioMCPClient");
                            setDesc("A tool can operate filesystem");
                            setDescForLlm("A tool can operate filesystem");
                            setEntrance(false);
                ...
                ReActAgent.builder()
                        ...
                        .tools(Arrays.asList("filesystem_tool"))
                ...
                ReActAgent.builder()
                        ...
                        .descForLlm("Master agent do file operations")
                        .category("agent")
                        .className("ReActAgent")
                        .subAgents(Arrays.asList("time_agent", "file_agent")) // Sub-agent list
                        .isMaster(true)
                        .llmModel("default_llm")
