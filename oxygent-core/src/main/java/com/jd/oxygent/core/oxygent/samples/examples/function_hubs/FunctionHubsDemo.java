...
public class FunctionHubsDemo {
    ...
    public static List<BaseOxy> getDefaultOxySpace() {
        ...
        return Arrays.asList(
                PresetTools.SQL_TOOLS,
                PresetTools.BAIDU_SEARCH_TOOLS,
                PresetTools.TRAIN_TICKET_TOOLS,
                PresetTools.DOCUMENT_TOOLS,
                PresetTools.SHORTEST_PATH_TOOLS,
                HttpLlm.builder()
                        .name("default_llm")
                        .apiKey(apiKey)
                        .baseUrl(baseUrl)
                ...
                ReActAgent.builder()
                        ...
                        .tools(Arrays.asList("baidu_search_tools", "sql_tools", "train_ticket_tools", "document_tools", "shortest_path_tools"))
                        .build()
        );
    }
