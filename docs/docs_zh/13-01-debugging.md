...
// 或者使用Mas直接启动调试服务
public static void startDebuggingService() throws Exception {
    var mas = new Mas("debugging_app", getDefaultOxySpace());
    mas.startWebService("How many chars in 'OxyGent'?");
}
```
