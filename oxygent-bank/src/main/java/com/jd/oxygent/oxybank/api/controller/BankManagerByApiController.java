...
/**
 * Bank Manager By API Controller
 * <p>
 * Provides user profile management and bank listing functionality
 */
@Slf4j
@RestController
@RequestMapping("/api/v1/bank")
public class BankManagerByApiController {
    ...
    public APIResponse<String> userProfileDeposit(@RequestBody UserProfileDepositRequest request) {
        try {
            ...
            // FIXME: Implement actual profile update logic
            // Currently just printing the content
            System.out.println(request.getAgent_pin() + " " + request.getUser_pin() + " " + request.getContent());
